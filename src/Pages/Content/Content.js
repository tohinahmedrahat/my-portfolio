        ...
        <div>
            <div className='flex justify-center mt-10 items-center gap-x-5'>
                ...
                <div data-aos="fade-down"
                    ...
                    data-aos-duration="1500" className='bg-[#1E1E1E] p-10 py-12 rounded-3xl relative'>
                ...
                <div data-aos="fade-left"
                    data-aos-offset="300"
                    data-aos-easing="ease-in-sine" className='bg-[#1E1E1E] relative p-8 rounded-3xl'>
            ...
            <div className='flex justify-center mt-10 items-center gap-x-5'>
                <div className='bg-[#191919] grid grid-cols-3 gap-x-5 p-10 rounded-3xl'>
                    ...
                    <div data-aos="fade-down"
                        data-aos-easing="linear"
                        data-aos-duration="1500" className='bg-[#202020] flex flex-col justify-center items-center px-7 py-10 rounded-3xl'>
                ...
                <div data-aos="zoom-out-down"
                    data-aos-offset="300"
                    data-aos-easing="ease-in-sine" className='bg-[#1E1E1E] relative px-10 rounded-3xl'>
                    <img src={icon} alt="" />
