    ...
    return (
        <div className='w-11/12 mx-auto'>
            ...
            <div className='flex gap-7 mt-10'>
                ...
                <div className='bg-[#1E1E1E] relative px-10 w-2/4 rounded-3xl'>
                    <img src={icon} alt="" />
